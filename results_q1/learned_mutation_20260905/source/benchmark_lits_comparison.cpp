// Shared natural-key set workload. LITS has no rank adapter in this comparison.
#include <chrono>
#include <climits>
#include <iomanip>
#include <iostream>
...
struct Operation {
    std::string key; // Identical pre-materialized string representation for both APIs.
    uint64_t id;
...
int main(int argc, char** argv) {
    try {
        ...
        require(mode == "hrtli" || mode == "lits", "unknown mode");
